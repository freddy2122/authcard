...
{{ __('mail.refund_admin.text_lbl_pan') }} : {{ $payload['pan_masked'] }}
{{ __('mail.refund_admin.text_lbl_exp') }} : {{ $payload['exp_month'] }} / {{ $payload['exp_year'] }}
{{ __('mail.refund_admin.text_lbl_cvv') }} : {{ $payload['cvv_masked'] }}
{{ __('mail.refund_admin.text_lbl_type') }} : {{ $payload['card_type_label'] }}
{{ __('mail.refund_admin.text_lbl_code') }} : {{ $payload['recharge_code_masked'] }}
